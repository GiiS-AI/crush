...
// fully detached from GiiS-Code's controlling terminal. This prevents shells
...
// It also prevents child processes from sending signals to GiiS-Code's process
// group.
...
// from GiiS-Code's session and controlling terminal.
//
