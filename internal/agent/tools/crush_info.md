Get GiiS-Code's current runtime state: active model, provider, LSP/MCP status, skills, hooks, permissions, and disabled tools. No parameters needed.
...
- Pair with the giis-code-config skill to fix configuration issues
</tips>
