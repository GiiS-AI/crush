...
func TestNewGiiSLogsTool(t *testing.T) {
	t.Parallel()
	tool := NewGiiSLogsTool("/tmp/test.log")
	require.NotNil(t, tool)
	require.Equal(t, GiiSLogsToolName, tool.Info().Name)
}

func TestGiiSLogs_HappyPath(t *testing.T) {
	t.Parallel()
	...
	result := runGiiSLogs(logFile, GiiSLogsParams{Lines: 3})
...
func TestGiiSLogs_DefaultLines(t *testing.T) {
	t.Parallel()
	...
	result := runGiiSLogs(logFile, GiiSLogsParams{Lines: 0})
...
func TestGiiSLogs_MaxCap(t *testing.T) {
	t.Parallel()
	...
	result := runGiiSLogs(logFile, GiiSLogsParams{Lines: 200})

	lines := strings.Split(result, "\n")
	require.Len(t, lines, 100)
}

func TestGiiSLogs_MissingFile(t *testing.T) {
	t.Parallel()
	result := runGiiSLogs("/nonexistent/path/giis-code.log", GiiSLogsParams{Lines: 50})
	require.Contains(t, result, "No log file found")
}

func TestGiiSLogs_EmptyFile(t *testing.T) {
	t.Parallel()
	tempDir := t.TempDir()
	logFile := filepath.Join(tempDir, "giis-code.log")
	...
	result := runGiiSLogs(logFile, GiiSLogsParams{Lines: 50})
	require.Contains(t, result, "Log file is empty")
}

func TestGiiSLogs_MalformedLines(t *testing.T) {
	t.Parallel()
	tempDir := t.TempDir()
	logFile := filepath.Join(tempDir, "giis-code.log")
	...
	result := runGiiSLogs(logFile, GiiSLogsParams{Lines: 10})
...
func TestGiiSLogs_ExtraFieldsSorted(t *testing.T) {
	t.Parallel()
	entries := []map[string]any{
	...
	result := runGiiSLogs(logFile, GiiSLogsParams{Lines: 1})
...
func TestGiiSLogs_NonStringValues(t *testing.T) {
	t.Parallel()
	entry := map[string]any{
...
func TestGiiSLogs_Redaction(t *testing.T) {
	t.Parallel()
	entries := []map[string]any{
...
func TestGiiSLogs_ReservedFields(t *testing.T) {
	t.Parallel()
	entries := []map[string]any{
		{
			"time":   time.Now().Format(time.RFC3339),
...
func TestGiiSLogs_OversizedLines(t *testing.T) {
	t.Parallel()
	tempDir := t.TempDir()
	logFile := filepath.Join(tempDir, "giis-code.log")
...
func TestGiiSLogs_PartialTrailingLine(t *testing.T) {
	t.Parallel()
	tempDir := t.TempDir()
	logFile := filepath.Join(tempDir, "giis-code.log")
...
func TestGiiSLogs_ValueQuoting(t *testing.T) {
	t.Parallel()
	entries := []map[string]any{
...
func TestGiiSLogs_ChronologicalOrder(t *testing.T) {
	t.Parallel()
...
func TestGiiSLogs_TimeOnlyFormat(t *testing.T) {
	t.Parallel()
	entry := map[string]any{
...
func TestGiiSLogs_LevelVariations(t *testing.T) {
	t.Parallel()
	entries := []map[string]any{
	...
	result := runGiiSLogs(logFile, GiiSLogsParams{Lines: 5})
...
func TestGiiSLogs_SourceVariations(t *testing.T) {
	t.Parallel()
	entries := []map[string]any{
