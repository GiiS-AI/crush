...
func TestGiiSInfo_MinimalConfig(t *testing.T) {
	t.Parallel()

	cfg := config.NewTestStore(&config.Config{
		Providers: csync.NewMap[string, config.ProviderConfig](),
	})
	output := buildGiiSInfo(cfg, nil, nil, nil, nil)
...
func TestGiiSInfo_ConfigFiles(t *testing.T) {
	t.Parallel()
...
func TestGiiSInfo_Models(t *testing.T) {
	t.Parallel()
...
func TestGiiSInfo_Providers(t *testing.T) {
	t.Parallel()
...
func TestGiiSInfo_DisabledProvidersOmitted(t *testing.T) {
	t.Parallel()
...
func TestGiiSInfo_LSPStates(t *testing.T) {
	t.Parallel()
	...
	output := buildGiiSInfo(cfg, mgr, nil, nil, nil)
...
func TestGiiSInfo_MCPStates(t *testing.T) {
	t.Parallel()
...
func TestGiiSInfo_YoloMode(t *testing.T) {
	t.Parallel()
...
func TestGiiSInfo_AllowedTools(t *testing.T) {
	t.Parallel()
...
func TestGiiSInfo_DisabledTools(t *testing.T) {
	t.Parallel()
...
func TestGiiSInfo_Options(t *testing.T) {
	t.Parallel()
...
func TestGiiSInfo_AutoSummarizeInversion(t *testing.T) {
	t.Parallel()
	...
	outputFalse := buildGiiSInfo(cfgFalse, nil, nil, nil, nil)
	...
	outputTrue := buildGiiSInfo(cfgTrue, nil, nil, nil, nil)
	require.Contains(t, outputTrue, "auto_summarize = true")
}

func TestGiiSInfo_NoSecrets(t *testing.T) {
	t.Parallel()
...
func TestGiiSInfo_DeterministicOrdering(t *testing.T) {
	t.Parallel()
...
func TestGiiSInfo_EmptySectionsOmitted(t *testing.T) {
	t.Parallel()
...
func TestGiiSInfo_ConfigStaleness_Clean(t *testing.T) {
	t.Parallel()
	...
	output := buildGiiSInfo(store, nil, nil, nil, nil)
...
func TestGiiSInfo_ConfigStaleness_Dirty(t *testing.T) {
	t.Parallel()
...
func TestGiiSInfo_ConfigStaleness_MissingPath(t *testing.T) {
	t.Parallel()
...
func TestGiiSInfo_Skills_NoSkills(t *testing.T) {
	t.Parallel()
...
func TestGiiSInfo_Skills_MixedLoadedUnloaded(t *testing.T) {
	t.Parallel()
	...
	output := buildGiiSInfo(cfg, nil, allSkills, activeSkills, tracker)
...
func TestGiiSInfo_Skills_DisabledSkills(t *testing.T) {
	t.Parallel()
...
func TestGiiSInfo_Skills_Ordering(t *testing.T) {
	t.Parallel()
...
func TestGiiSInfo_Skills_BuiltinOrigin(t *testing.T) {
	t.Parallel()
...
func TestGiiSInfo_Hooks(t *testing.T) {
	t.Parallel()
...
func TestGiiSInfo_Hooks_NoHooks(t *testing.T) {
	t.Parallel()
