...
giis-code update-providers

# Update Catwalk providers from a custom URL
giis-code update-providers https://example.com/providers.json

# Update Catwalk providers from a local file
giis-code update-providers /path/to/local-providers.json

# Update Catwalk providers from embedded version
giis-code update-providers embedded

# Update Hyper provider information
giis-code update-providers --source=hyper

# Update Hyper from a custom URL
giis-code update-providers --source=hyper https://hyper.example.com
`,
