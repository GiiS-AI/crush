...
type Styles struct {
	...
	// GiiS-Code's background. Defining them here keeps output readable and
	...
	Header struct {
		...
		LogoGradCanvas    lipgloss.Style // Canvas for the compact "GiiS" gradient
		LogoGradFromColor color.Color    // "GiiS" wordmark gradient start
		LogoGradToColor   color.Color    // "GiiS" wordmark gradient end
	}
	...
	Logo struct {
		...
		SmallGradFromColor color.Color    // Small "GiiS-Code" wordmark gradient start
		SmallGradToColor   color.Color    // Small "GiiS-Code" wordmark gradient end
	}
