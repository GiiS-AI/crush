...
// sidebarScrollbarHideDuration is how long the sidebar scrollbar stays
// visible after a scroll before auto-hiding (while unfocused).
const sidebarScrollbarHideDuration = 2 * time.Second
...
func sidebarScrollbarHideCmd(seq int) tea.Cmd {
	return tea.Tick(sidebarScrollbarHideDuration, func(_ time.Time) tea.Msg {
